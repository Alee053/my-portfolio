...
- [x] 1.3 Create src/layouts/V2Layout.astro with fixed header/nav, footer, body classes for brutalist

## 2. Landing Page (v2-brutalist-landing)

- [x] 2.1 Update src/pages/v2/index.astro: hero section with h1 name/subtitle, left border, section label [SEC 01 // HERO]
...
- [x] 2.4 Use V2Layout, ensure grid bg/lines

## 3. Projects Browser (v2-projects-browser)

- [x] 3.1 Create src/pages/v2/projects.astro using V2Layout; section label [SEC // PROJECTS BROWSER], h2 Projects, search input in border box
...
- [x] 4.1 Create src/pages/v2/blogs.astro using V2Layout; [SEC // BLOGS BROWSER], h2 Blogs, search/filter
...
- [x] 4.5 Item click: router.navigate(`/v2/blog/${blog.slug}`) or <a href={`/v2/blog/${blog.slug}`}

## 5. Blog Renderer (v2-blog-renderer)

- [x] 5.1 Create src/pages/v2/blog/[slug].astro
...
- [x] 5.4 Add back link to /v2/blogs
...
- [ ] 6.5 Update nav links to /v2/projects etc.