...
The system SHALL provide a Blogs.svelte component in src/sections/v2/ that renders the blogs teaser with brutalist styling.
...
- **AND** it SHALL include a "[VIEW ALL]" link to /v2/blogs
...
- **THEN** it SHALL navigate to /v2/blog/{slug}
